  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white via-emerald-50 to-emerald-100 text-slate-900 py-12">
      <div className="container mx-auto px-6">
        {/* ---------- IMPORTANT FRAUD WARNING MODAL (CLIENT-FREE, peer toggle) ---------- */}
        {/* The checkbox is checked by default so the modal is visible on first render.
            Clicking the "I understand / मैं समझ गया" label toggles it off. */}
        <input id="truemate-fraud-modal" type="checkbox" defaultChecked className="peer hidden" />
        <div className="fixed inset-0 z-50 items-center justify-center bg-black/60 peer-checked:flex hidden">
          <div className="max-w-xl w-full mx-4">
            <div className="bg-white rounded-2xl p-6 shadow-xl">
              <h2 className="text-lg font-bold mb-2">Important — Official site & fraud alert</h2>

              <p className="text-sm text-slate-700 mb-3">
                <strong>Official site:</strong> <span className="font-medium">https://www.truemateai.com</span>
              </p>

              <p className="text-sm text-slate-700 mb-3">
                If you are offered Truemate access anywhere else, or at a different price, it is likely fraud.
                Purchases outside the official site are not supported and may be unsafe.
              </p>

              

              <p className="text-xs text-slate-500 mb-4">
                Need verification? Email <span className="font-medium">bothinnovations@gmail.com</span>.
              </p>

              <div className="flex gap-3 justify-end">
                {/* label toggles the checkbox (closes modal) */}
                <label
                  htmlFor="truemate-fraud-modal"
                  className="inline-flex items-center px-4 py-2 rounded-lg bg-emerald-600 text-white font-semibold cursor-pointer select-none"
                >
                  I understand.
                </label>
                ...
                <Link
  href="/faq"
  className="inline-flex items-center px-4 py-2 rounded-lg bg-white text-emerald-600 border border-emerald-200 font-medium"
>
  Learn more
</Link>
